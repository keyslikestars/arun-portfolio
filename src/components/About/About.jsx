...
import { RiDownload2Fill, RiInstagramLine, RiWhatsappLine } from "react-icons/ri";
    ...
    <div className="about reveal">
      ...
      <div className="about-sections">
        <div className="about-left reveal">
          <img src={aboutbg} alt="About-me" />
        </div>
        <div className="about-right">
          <div className="about-para">
            <p>
            Hi, I'm Arun Suresh, a passionate Front-End Developer with a love for crafting beautiful 
            and responsive web applications. I specialize in HTML, CSS, JavaScript, 
            React, and modern front-end frameworks.responsible for designing and implementing the 
            user interface (UI) and user experience (UX) of a website or web application.            
            </p>
            <p>
            As a Front-End Developer, having experience with different developing softwares is a game-changer. 
            </p>
          </div>
          <div className="about-skills">
            <div className="about-skill">
              <FaHtml5 color="orange" fontSize="25px"></FaHtml5>
              <h3>HTML</h3>
              <span>
                  <hr style={{ width: "90%", background:"orange" }} />
              </span>
              <h4>90%</h4>
            </div>
            <div className="about-skill">
              <FaCss3Alt style={{ color: "#3c99dc", fontSize:"25px" }}></FaCss3Alt>
              <h3>CSS</h3>
              <span>
                  <hr style={{ width: "90%", background:"#3c99dc" }} />
              </span>
              <h4>90%</h4>
            </div>
            <div className="about-skill">
              ...
              <h3>JAVASCRIPT</h3>
                  <span>
                      <hr style={{ width: "70%", background:"#ffde25" }} />
                  </span>
                  <h4>70%</h4>
            </div>
            <div className="about-skill">
              <FaReact color="#26e4f9" fontSize="25px"></FaReact>
              <h3>REACT JS</h3>
              <span>
                  <hr style={{ width: "60%", background:"#26e4f9" }} />
              </span>
              <h4>60%</h4>
            </div>
            <div className="about-skill">
              <FaSass color="#ff1563" fontSize="25px"></FaSass>
              <h3>SASS</h3>
              <span>
                  <hr style={{ width: "85%", background:"#ff1563" }} />
              </span>
              <h4>85%</h4>
            </div>
            <div className="about-skill">
              <svg viewBox="0 0 128 128" id="jquery" width="25px">
                <path
                  fill="#0868AC"
              ...
              <h3>jQuerry</h3>
              <span>
                  <hr style={{ width: "65%", background:"#0868AC" }} />
              </span>
                  <h4>65%</h4>
            </div>
          </div>
      ...
      <div className="about-achievements">
        ...
        <a href="//wa.me/9995677813/?text=Hello%20im%20Arun%20How%20can%20Help%20You?`"><h1><RiWhatsappLine/></h1>
          <p>Send Message</p>
          </a>
        </div>
        <hr />
        <div className="about-achievement aa2">
          <a href="https://www.instagram.com/_arunps__/">
            <h1><RiInstagramLine/></h1>
            <p>Follow me</p>
          </a>
        </div>
        <hr />
